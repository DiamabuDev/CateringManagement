    ...
    public class CateringContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Work>()
                .HasIndex(w => new { w.WorkerID, w.FunctionID })
                .IsUnique();
            ...
            //has many documents with on function. function has many documents. with one funtion. hasforegithkeyfunction .ondelete, cascate
        }
